        ...
        <div class="flex flex-wrap bg-gray-100 w-full h-screen">
            <div class="w-3/12 bg-white rounded p-3 shadow-lg">
                <div class="flex flex-col justify-center items-center p-2 mb-8 text-center">
                    ...
                    <div class="">
                        <img class="h-16 bg-gray-100 rounded-full" src="@/assets/images/man.png" alt="John Doe">
                    </div>
                    <div>
                        <h4 class="font-semibold md:text-2xl text-lg pt-2 text-gray-700 capitalize font-poppins tracking-wide">John Doe</h4>
                        <span class="text-sm text-gray-500 tracking-wide flex items-center py-2">
                        +2547 0123 4567
                        </span>
                    </div>
                </div>
                <ul class="space-y-4 text-sm">
                    ...
                    <li>
                        <a href="#" class="flex items-center space-x-3 text-red-600 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
