...
onMounted(async () => {
  ...
  total_rate.value =
    parseFloat(car.value.car_engine) +
    parseFloat(car.value.car_milage) +
    parseFloat(car.value.car_transmission) +
    parseFloat(car.value.car_fuel) +
    parseFloat(car.value.car_steering) +
    parseFloat(car.value.car_tyre) +
    parseFloat(car.value.car_body) +
    parseFloat(car.value.car_electric) +
    parseFloat(car.value.car_accessories) +
    parseFloat(car.value.car_interior);
  console.log(total_rate.value);

  final_price.value =
    ((total_rate.value / 50) * parseFloat(car.value.car_price)) | 0;
